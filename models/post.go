...
var PostWhere = struct {
	...
	AuthorID:  whereHelpernull_Int{field: "`post`.`author_id`"},
...
var (
	postAllColumns            = []string{"id", "author_id", "title", "body", "created_at", "updated_at", "deleted_at"}
	postColumnsWithoutDefault = []string{"author_id", "title", "body", "created_at", "updated_at", "deleted_at"}
