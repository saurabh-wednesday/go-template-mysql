...
var WhiteListedOperations = map[string][]string{
	"query":        {"__schema", "introspectionquery", "userNotification", "getPosts", "getAuthors"},
	"mutation":     {"login", "createPost", "updatePost", "deletePost", "createAuthor", "updateAuthor", "deleteAuthor"},
